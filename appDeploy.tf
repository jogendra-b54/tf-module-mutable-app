resource "null_resource" "app_deploy" {
  ...
  # connection block establishes connection to this 
   connection {
    ...
    inline = [
         "ansible-pull -U https://github.com/jogendra-b54/ansible.git -e MONGODB_ENDPOINT=${data.terraform_remote_state.databases.outputs.MONGODB_ENDPOINT} -e ENV=dev -e COMPONENT=${var.COMPONENT} -e APP_VERSION=${var.APP_VERSION} roboshop-pull.yml",
    ]
  }
